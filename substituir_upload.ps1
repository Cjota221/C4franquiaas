# Script para substituir a função handleCustomUpload

$filePath = "components\revendedora\BannerEditorFinal.tsx"
$content = Get-Content $filePath -Raw -Encoding UTF8

# Nova função simplificada (usando API endpoint)
$newFunction = @'
...
# Padrão regex para encontrar a função antiga (simples - só o início e fim)
$pattern = '(?s)const handleCustomUpload = async \(e: React\.ChangeEvent<HTMLInputElement>, type: "desktop" \| "mobile"\) => \{.*?\n  \};'
