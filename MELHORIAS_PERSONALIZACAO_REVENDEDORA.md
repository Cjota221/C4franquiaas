...
<div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-xl">
  ...
  <ul className="text-xs text-blue-700 mt-2 space-y-1">
    <li>
      • Use imagem com <strong>fundo transparente (PNG)</strong>
    </li>
    <li>
      • <strong>Redonda:</strong> ideal para logos circulares (200x200px)
    </li>
    <li>
      • <strong>Horizontal:</strong> ideal para logos retangulares (400x100px)
    </li>
  </ul>
</div>
```
